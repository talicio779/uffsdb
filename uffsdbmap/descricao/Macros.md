Macros é um arquivo para definir constantes do sistema.

obs: nem toda constante está localizada em macros :(.
# Tratamento de erros
...
#define LEN_DB_NAME_IO (LEN_DB_NAME << 1) // 20 * 2 = 40
#define DB_EXISTS 1
